...
public class CSVWrapper {
    ...
    private String config(String name, Map<String, List<String>> childrenMap, Map<String, Integer> idMap) {
    	...
    	if (nextId==null) {
    		...
    		return name + delimeter + property + delimeter + "" + delimeter + "" + delimeter + "" + delimeter + "" + delimeter + "" + delimeter + "";    		
    	} 
		...
		return name + delimeter + property + delimeter + "" + delimeter + next(nextId, childrenMap, idMap, 3) + delimeter + "" + delimeter + "" + delimeter + "" + delimeter + "";
    }

...
public class LINEAPI {
    ...
    private static final String PREVIEW_MEDIA_URL = "https://wayobot.com/assets/images/WAYOBOT512.png";
    ...
    private JSONObject createCarouselTemplate(List<Question> questionList) {
        ...
        for (Question question:questionList) {
            ...
            if (question.hasImage()) {
            	 ...
            	 * Default Image
            	 */
                column.put("thumbnailImageUrl", "https://wayobot.com/assets/images/muay_smiling.png");
            }

      ...
      "changes": [
        {
          "value": {
            ...
            "message": "testna",
            "post_id": "147172370409_10160563860675410",
            "comment_id": "10160563860675410_10160563885055410",
            "created_time": 1615534998,
            "item": "comment",
            "parent_id": "147172370409_10160563860675410",
            "verb": "add"
          },
          "field": "feed"
        }
                		...
                		recipientId = entryObj.getString("id");
                		...
                		if (!recipientId.equals(fromId)) {
                			...
                			message = "facebook-feed " + changeObj.getString("message");
			...
			for (String text:tokens) {
				...
				try {
					...
					if (responseCode == HttpURLConnection.HTTP_OK) {
						...
						relocatedContents.append(Configuration.domain + "/" + contentName);

...
public class ExtLinkMenuSupportWayDrawer extends Drawer {
	...
	public ExtLinkMenuSupportWayDrawer(String content) {
		...
		if (!menuItemsText.isEmpty()) {
	        ...
	        for (String c:tokens) {
	        	...
	        	*/
	        	...
	        	} else if (c.contains("https://")) { //External Link Support
	        		
	        		keyword = c.substring(0, c.indexOf("https://")).trim();
	        		
	        		responseText = c.substring(c.indexOf("https://")).trim();
	        	...
	        	} else if (responseText.startsWith("https://")) {//External Link Support

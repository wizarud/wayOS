 ...
 */
public class MultilineInputAdminWakeupCommandNode extends CommandNode {

    public static final Key KEY = new Key("\uD83D\uDE0A", "?", Arrays.asList("\uD83D\uDC4D", "\uD83D\uDC4E", "ไม่"));
    
    public MultilineInputAdminWakeupCommandNode(Session session) {
        super (session);
    }
    ...
    public String execute(MessageObject messageObject) {
         ...
         * Just acknowledge.
         */
        session.adminCommandList().add(new AdminCommandNode(new CommandNode(session, new String[]{"iamyourfather"}) {

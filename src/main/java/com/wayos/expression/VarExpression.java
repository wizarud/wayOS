                ...
                if (isNumeric(oldValue) && isNumeric(newValue)) {
                	...
                	*/
                    ...
                    if (opt.equals("*")) {
                    	 ...
                    	 */
                    	String delimiter = session.vars("delimiter");
                    	
                    	if (delimiter==null || delimiter.isEmpty() || delimiter.equals("\\s+")) {
                    ...
                    if (opt.equals("/")) {
                    	...
                    	/**
                    	 * For new line
                    	 * Logic Designer use _newline_ as a single line separator
                    	 */
                    	newValue = newValue.replace("_newline_", "\n");
